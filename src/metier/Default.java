    ...
    public static Node [][] getGame(int N){
        ...
        switch(N){
            ...
            case 8: 
                ...
                break;
            case 9: 
                nodes[0][0].setDefaultValue(5);
                nodes[1][3].setDefaultValue(6);
                nodes[1][5].setDefaultValue(8);
                nodes[1][7].setDefaultValue(5);
                nodes[2][0].setDefaultValue(4);
                nodes[4][0].setDefaultValue(7);
                nodes[4][1].setDefaultValue(8);
                nodes[4][3].setDefaultValue(3);
                ...
                nodes[2][4].setRowConstraint(">");
                nodes[4][5].setRowConstraint(">");
                nodes[4][6].setRowConstraint(">");
                nodes[5][0].setRowConstraint(">");
                nodes[7][3].setRowConstraint(">");
                nodes[7][7].setRowConstraint(">");
                nodes[0][0].setRowConstraint("<");
                nodes[2][3].setRowConstraint("<");
                nodes[2][7].setRowConstraint("<");
                nodes[3][1].setRowConstraint("<");
                nodes[5][1].setRowConstraint("<");
                nodes[6][1].setRowConstraint("<");
                nodes[7][0].setRowConstraint("<");
                nodes[7][5].setRowConstraint("<");
                nodes[0][4].setColumnConstraint(">");
                nodes[2][0].setColumnConstraint(">");
                nodes[4][4].setColumnConstraint(">");
                nodes[4][7].setColumnConstraint(">");
                nodes[5][3].setColumnConstraint(">");
                nodes[6][0].setColumnConstraint(">");
                nodes[6][3].setColumnConstraint(">");
                nodes[6][4].setColumnConstraint(">");
                nodes[6][5].setColumnConstraint(">");
                ...
                nodes[3][4].setColumnConstraint("<");
                nodes[3][7].setColumnConstraint("<");
                nodes[5][6].setColumnConstraint("<");
                nodes[5][7].setColumnConstraint("<");
